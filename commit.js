...
async function run() {
  const response = await fetch("https://api.github.com/repos/1P-sigmaboy/bh2026-vault-commit/git/refs/heads/main");
  const { object } = await response.json();

  await fetch("https://api.github.com/repos/1P-sigmaboy/bh2026-vault-commit/git/commits", {
    method: "POST",
    headers: {
